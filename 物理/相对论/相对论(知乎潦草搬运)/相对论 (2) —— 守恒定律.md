...
$\partial_\color{red}\mu \color{darkblue}J^\color{red}\mu=\partial_\color{red}\mu\Big(\frac{\partial \color{orange}L}{\partial(\partial_\color{red}\mu\color{blue}\phi)}\ \delta\color{blue}\phi\Big)=0$其中$L=L(\partial_\mu\phi,\phi)为拉格朗日密度，$$J^\mu$称为守恒流。
...
$\frac{\partial\color{orange}L}{\partial\color{blue}{\dot x}^\color{red}\mu}\delta \color{blue}x^\color{red}\mu-\color{darkblue}f\equiv \color{darkblue}J$由于$\frac{\partial L}{\partial\dot x^\mu}即为广义动量$$p_\mu$，故上式也可写为
...
$p_\color{orange}r=m\color{orange}{\dot r}$(3) 若可遗坐标为极角$x^2=\theta$，则(极)角动量守恒

$p_\color{red}\theta=m\color{orange}{r^2}\color{red}{\dot\theta}$(4) 若可遗坐标为方位角$x^3=\phi$，则(方位)角动量守恒

$p_\color{blue}\phi=m\color{orange}{r^2}\sin^2\color{red}\theta\ \color{blue}{\dot\phi}$
...
$\color{darkblue}J^\color{red}\mu\equiv\frac{\partial \color{orange}L}{\partial(\partial_\color{red}\mu\color{blue}\phi)}\ \delta\color{blue}\phi,\ \partial_\color{red}\mu \color{darkblue}J^\color{red}\mu=0$