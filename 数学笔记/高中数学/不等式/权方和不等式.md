...
>$$\begin{array}{l}\color {Red}{\sum_{i=1}^{n} a_{i} b_{i} \geqslant\left(\sum_{i=1}^{n} a_{i}^{p}\right)^{\frac{1}{p}}\left(\sum_{i=1}^{n} b_{i}^{q}\right)^{\frac{1}{q}}\qquad(0<p<1) \tag 2}\end{array}$$
>
> 当且仅当  $\dfrac{a_{1}^{p}}{b_{1}^{q}}=\dfrac{a_{2}^{p}}{b_{2}^{q}}=\cdots=\dfrac{a_{n}^{p}}{b_{n}^{q}}$  时, 以上两式等号成立.
> 详见 [[赫尔德不等式]]
> #代数 #不等式
