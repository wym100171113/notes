...
$\begin{align} \delta S=\int_{t_0}^{t_1}{\delta Ldt}=\int_{t_0}^{t_1}{ \left( \frac{\partial L}{\partial\dot q}\delta \dot q+\frac{\partial L}{\partial q}\delta q \right)dt } \end{align}$ 

由变分的基础知识可知，变分符号与微分符号可以互换，并注意到在边界处$\delta q=0$ ：

$\begin{align} \int_{t_0}^{t_1}{ \frac{\partial L}{\partial\dot q}\delta \dot qdt}&= \int_{t_0}^{t_1}{\frac{\partial L}{\partial\dot q}d\delta q}\\\\&= \left[ \delta q\frac{\partial L}{\partial\dot q} \right]_{t_0}^{t_1}- \int_{t_0}^{t_1}{\frac{d}{dt}\frac{\partial L}{\partial \dot q}\delta qdt}\\\\&= - \int_{t_0}^{t_1}{\frac{d}{dt}\frac{\partial L}{\partial \dot q}\delta qdt}  \end{align}$ 

代入前式并令作用量的变分为$0$ ：

$\begin{align} \delta S =\int_{t_0}^{t_1}{ \left( \frac{\partial L}{\partial q}- \frac{d}{dt}\frac{\partial L}{\partial\dot q} \right)\delta qdt= 0 } \end{align}$ 
...
$F=\frac{\partial L}{\partial q}，p=\frac{\partial L}{\partial \dot q}$ 
 ...
 因此可得$\begin{align} &\int_{0}^{L}{dL}=\int_{0}^{q}{Fdq}\Rightarrow L_{1}^{\ast}=-U\\ &\int_{0}^{L}{dL}=\int_{0}^{t}{Pdt}\ \Rightarrow L_{2}^{^\ast}=\ \ T \end{align}$ 
...
$\left\{ \begin{align} &p=\frac{\partial S}{\partial q}\\ &T=\frac{1}{2m}\left(\frac{\partial S}{\partial q}\right)^2\\ &E=H=-\frac{\partial S}{\partial t} \end{align} \right.$ 
...
$\begin{align} T=& 2\pi\sqrt{\frac{l}{g}}\sum_{n=0}^{\infty}{\left[  \frac{(2n)!}{2^{2n}n!^2}sin^n\frac{\alpha}{2} \right]^2}\\\\=& 2\pi\sqrt{\frac{l}{g}}\left( 1+\frac{\alpha^2}{16}+\frac{11\alpha^4}{3072}+\frac{173\alpha^6}{737280}+\frac{22931\alpha^8}{1321205760}+\cdots \right)\\\\=& 2\pi\sqrt{\frac{l}{g}}+o(\alpha) \end{align}$ 
...
$\left\{ \begin{align} x=&k(\theta-sin\theta)\\ y=&k(1-cos\theta) \end{align} \right.$ 
...
$\left\{ \begin{align} &x=k(\theta-sin\theta)\\\\ &y=h-k(1-cos\theta) \end{align} \right.$
...
基矢量的微分$\left\{ \begin{align} d\mathbf{e_r}=&d\theta\mathbf{e_\theta}\\ d\mathbf{e_\theta}=&-d\theta\mathbf{e_r} \end{align} \right.$ 
...
$\begin{align} a=&\ddot r-r\dot\theta^2 \end{align}$ 
...
$\begin{align} \frac{dL}{dt}=&\frac{d}{dt}(r\times p)\\\\ =&\frac{dr}{dt}\times mv+r\times m\frac{dv}{dt}\\\\ =&m(v\times v)+r\times F\\\\ =&r\times F\\\\ =&M \end{align}$ 
...
$\left\{ \begin{align} \frac{\partial L}{\partial r}-\frac{d}{dt}\frac{\partial L}{\partial\dot r}=&0\\ \frac{\partial L}{\partial \theta}-\frac{d}{dt}\frac{\partial L}{\partial\dot \theta}=&0 \end{align} \right.$ 
...
$\left\{ \begin{align} &m\ddot r-m\dot\theta^2=-\frac{k}{r^2}\\ &mr^2\ddot\theta=0 \end{align} \right.$ 
...
$\begin{align} \int{\frac{d\theta}{\sqrt{cos\theta-cos\alpha}}}=&\frac{\sqrt{2}}{2}\int{\frac{2sin\frac{\alpha}{2}cos\beta}{\sqrt{1-sin^2\frac{\alpha}{2} sin^2\beta}}\frac{d\beta}{sin\frac{\alpha}{2}\sqrt{1-sin^2\beta}}}\\ \\=&  \sqrt{2}\int{\frac{d\beta}{\sqrt{1-sin^2\frac{\alpha}{2}sin^2\beta}}}\\ \\=&  \sqrt2K(sin\frac{\alpha}{2})+C \end{align}$ 
...
$\begin{align} \ \ \vartheta_{\ \ }=&\ \vartheta_3=\sum_{n=-\infty}^{\infty}{w^{2n}q^{n^2}}\\ \ \ \vartheta_{01}=&\ \vartheta_4=\sum_{n=-\infty}^{\infty}{(-1)^nw^{2n}q^{n^2}}\\ \ \ \vartheta_{10}=&\ \vartheta_1=\ \ q^{\frac{1}{4}}\sum_{n=-\infty}^{\infty}{w^{2n+1}q^{n^2+n}}\\ \ \ \vartheta_{11}=&\ \vartheta_2=\ iq^{\frac{1}{4}}\sum_{n=-\infty}^{\infty}{(-1)^nw^{2n+1}q^{n^2+n}} \end{align}$ 